  ...
  "container_scanning": {
    "secrets": {
      "vault": {
        ...
        "aws_role": "secret/data/cloud/aws/sts/cicd-ecr-readonly"
      }
    },
    "fossa": {
      "policy": {
...
| Field | Default Value |
|-------|---------------|
| `vault_secret_path` | `secret/data/tools/githubactions` |
...
- uses: SolaceDev/solace-public-workflows/.github/workflows/container-scan-and-guard.yaml@main
  with:
    ...
    vault_secret_path: "secret/data/tools/githubactions"
    vault_aws_role: "secret/data/cloud/aws/sts/cicd-ecr-readonly"
